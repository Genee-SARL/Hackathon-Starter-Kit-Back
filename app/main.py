...
get_user_daily_balance_scheduler = scheduler.add_job(lambda: scraper_manager.check_user_balance(app, 0), 'cron', hour=1,
                                                     minute=0,
                                                     second=0,
                                                     day_of_week='mon-fri', timezone=paris_tz)
get_user_balance_scheduler = scheduler.add_job(lambda: scraper_manager.check_user_balance(app, 1),
